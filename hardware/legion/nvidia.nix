...
{
  boot.kernelParams = [
    # Fix Wayland flickering & AMD-Vi IO_PAGE_FAULT errors
    # https://gitlab.freedesktop.org/drm/nouveau/-/issues/225
    "iommu=pt"
  ];

  # Separate boot entry for the proprietary Nvidia drivers
  # NOTE: nouveau is used in the default boot entry
  specialisation = {
    prop-nvidia.configuration = {
